...
public class pixelsBlueClose extends OpenCvPipeline {
    Mat HSVMat = new Mat();
    ...
    public Mat processFrame(Mat input) {
        ...
        //Config Scalars
        Scalar lowerBlue = new Scalar(pixelssBlueClose.lowerBlueH,pixelssBlueClose.lowerBlueS,pixelssBlueClose.lowerBlueV);
        Scalar upperBlue = new Scalar(pixelssBlueClose.upperBlueH,pixelssBlueClose.upperBlueS,pixelssBlueClose.upperBlueV);
        ...
        */
        ...
        for(MatOfPoint contour : contoursList){
            ...
            if(area>= pixelssBlueClose.threshold && center.y>=pixelssBlueClose.horizon){
...
class sortArrBlue implements Comparator<MatOfPoint> {
    public int compare(MatOfPoint a, MatOfPoint b)
    {
        ...
        if(pixelsBlueClose.calculateCentroid(aMom).x > pixelsBlueClose.calculateCentroid(bMom).x){
            return 1;
        }else{
            return -1;
        }
